...
* General setup
** Startup performance
[[https://github.com/daviwil/emacs-from-scratch/blob/d23348b4a52dde97f4f7cbcd66a519b5fd0a143c/Emacs.org#startup-performance][emacs-from-scratch/Emacs.org at d23348b4a52dde97f4f7cbcd66a519b5fd0a143c · daviwil/emacs-from-scratch · GitHub]]
...
#+RESULTS:
: #s(hash-table data (:use-package (27163 8739 373485 243000) :init (27163 8739 373477 180000) :config (27163 8739 373465 513000) :config-secs (0 0 24908 129000) :init-secs (0 0 29431 653000) :use-package-secs (0 0 40152 518000)))
...
*** Set file apps
Set default apps for opening attachments, links, etc.
#+begin_src emacs-lisp
